							...
							<Row className='form-group'>
								<Col md={12}>
									<Label htmlFor='author'>
										<h6 class="text-secondary">Your Name</h6>
									</Label>
							...
							<Row className='form-group'>
								<Col md={12}>
									<Label htmlFor='comment'>
										<h6 classt='text-secondary'>Comment</h6>
									</Label>
									<Control.textarea model='.comment' id='comment' name='comment' rows="6" className="form-control text-dark"></Control.textarea>
								</Col>
							</Row>
							<Row className='form-group'>
								<Col md={12}>
